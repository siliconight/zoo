"""sign_post recipe: PLACEHOLDER SILHOUETTE, minted 2026-09-12 by tools/new_species.py.
...
counted as itself in every kit report. It is NOT yet a sign_post: this file
...
def build(plan, streams, collection):
    ...
    part(bm, "SignPost_Body")
    cboxes.append(((-w / 2, -d / 2, -h / 2), (w / 2, d / 2, h / 2)))

    surface = materials.make_material(
        f"M_SignPost_{plan['material']}", plan["color"], plan["material"])
