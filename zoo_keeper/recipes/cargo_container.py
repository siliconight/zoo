"""cargo_container recipe: PLACEHOLDER SILHOUETTE, minted 2026-09-12 by tools/new_species.py.
...
counted as itself in every kit report. It is NOT yet a cargo_container: this file
...
def build(plan, streams, collection):
    ...
    part(bm, "CargoContainer_Body")
    cboxes.append(((-w / 2, -d / 2, -h / 2), (w / 2, d / 2, h / 2)))

    surface = materials.make_material(
        f"M_CargoContainer_{plan['material']}", plan["color"], plan["material"])
