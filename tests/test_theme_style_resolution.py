...
def test_delco_1997_reaches_every_species():
    ...
    61 with the interior species of 0.84.0, each authored with `delco`; 66
    with the club species of 0.87.0, likewise."""
    ...
    # 66 hand-authored species, plus whatever tools/new_species.py has
    ...
    assert len(_genomes()) == 69 + len(_minted), len(_genomes())
